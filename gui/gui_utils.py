...
def setup_dark_theme():
    ...
    style.map('Orange.TButton',
             ...
             foreground=[('active', COLORS['text_bright']), ('pressed', COLORS['text_bright'])])
...
def create_header_frame(parent: tk.Widget, title: str, subtitle: str = None,
                       height: int = 120) -> tk.Frame:
...
def create_label(parent: tk.Widget, text: str, font_key: str = 'label',
                color_key: str = 'text_primary', bg: str = None, **pack_kwargs) -> tk.Label:
...
def create_button(parent: tk.Widget, text: str, command: Callable,
                 color_key: str = 'accent', text_color: str = None,
                 font_key: str = 'body_bold', width: int = None, **pack_kwargs) -> ttk.Button:
...
def create_labeled_entry(parent: tk.Widget, label_text: str, show: str = None,
                        pady_top: int = 15) -> tk.Entry:
...
def create_combobox(parent: tk.Widget, values: list, default: str = None,
                   width: int = None, **pack_kwargs) -> tuple[tk.StringVar, ttk.Combobox]:
...
def create_modal_dialog(parent: tk.Widget, title: str, width: int = 400,
                       height: int = 300) -> tk.Toplevel:
...
def create_button_pair(parent: tk.Widget, primary_text: str, primary_command: Callable,
                      secondary_text: str, secondary_command: Callable,
                      primary_color: str = 'accent') -> tk.Frame:
